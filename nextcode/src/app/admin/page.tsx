...
const AdminDashboard: React.FC = () => {
            ...
            <div className="!h-screen !bg-[#f8f9fc] !font-sans !flex !relative !overflow-hidden">
                ...
                <div className="!w-[280px] !bg-gradient-to-b !from-yellow-50/70 !via-yellow-100/50 !to-yellow-50/60 !backdrop-blur-3xl !border-r !border-white/70 !shadow-[4px_0_40px_rgba(234,179,8,0.2)] !flex !flex-col !h-screen !relative !z-20">
                    ...
                    <div className="!pt-8 !px-8 !pb-4 !relative !z-10">
                        ...
                        <p className="!text-xs !font-bold !text-gray-600 !uppercase !tracking-wider !mt-1 !mb-6">Admin Portal</p>
    ...
    return (
        <div className="!bg-[#f8f9fc] !min-h-screen">
            {canteenId ? <SellerDashboard canteenId={canteenId} email={email} onLogout={handleLogout} /> : (
                <div className="!max-w-7xl !mx-auto !p-8">
                    <div style={{ backgroundColor: '#FEF2F2', borderLeft: '4px solid #EF4444', color: '#B91C1C', padding: '1.5rem', borderRadius: '0.375rem', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.1)' }}>
                        ...
                        <button onClick={handleLogout} className="!mt-4 !px-4 !py-2 !bg-red-500 hover:!bg-red-600 !text-white !rounded-md !font-bold">Logout</button>
                    </div>
                </div>
            )}
        </div>
